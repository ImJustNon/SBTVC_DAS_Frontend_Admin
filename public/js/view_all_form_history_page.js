async function showMore(id){
    if(!id) return;
    try{
        const response = await axios.post(`https://sbtvc-das-api.nonlnwza.xyz/api/admin/form/get_home_form_history_data`, {
            form_id: id,
        }, {
            headers: {
    ...
    try{
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = await axios.post(`https://sbtvc-das-api.nonlnwza.xyz/api/admin/form/delete_home_form_history_data`, {
                    form_id: id,
                }, {
                    headers: {
                        'Content-Type': 'application/json'

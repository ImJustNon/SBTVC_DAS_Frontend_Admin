...
async function UpdateOutLocationAuth(student_id, status){
    try{
        const response = await axios.post('https://sbtvc-das-backend-2.vercel.app/api/admin/form/update_form/update_out_location_auth', {
...
async function UpdateInLocationAuth(student_id, status){
    try{
        const response = await axios.post('https://sbtvc-das-backend-2.vercel.app/api/admin/form/update_form/update_in_location_auth', { 
            student_id: student_id,
            status: status,
        }, {
            headers: {

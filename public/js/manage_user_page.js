...
add_user_btn.addEventListener("click", async() =>{
    try{
        const response = await axios.post('https://sbtvc-das-api.nonlnwza.xyz/api/users/add_student_user', {
            secret_key: "nonlnwza",
...
remove_user_btn.addEventListener("click", async() =>{
    swal({
        ...
        if(confirm){
            try{
                const response = await axios.post('https://sbtvc-das-api.nonlnwza.xyz/api/users/remove_student_user', {
                    secret_key: "nonlnwza",
